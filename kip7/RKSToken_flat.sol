// File: @klaytn/contracts/utils/math/SafeMath.sol
...
// File: @klaytn/contracts/KIP/utils/introspection/IKIP13.sol
...
// File: @klaytn/contracts/KIP/interfaces/IKIP13.sol
...
// File: @klaytn/contracts/KIP/token/KIP7/KIP7.sol
...
// File: @klaytn/contracts/security/Pausable.sol
...
// File: @klaytn/contracts/access/IAccessControl.sol
...
// File: @klaytn/contracts/access/IAccessControlEnumerable.sol
...
// File: @klaytn/contracts/utils/Strings.sol
...
// File: @klaytn/contracts/utils/introspection/IERC165.sol
...
// File: @klaytn/contracts/utils/introspection/ERC165.sol
...
// File: @klaytn/contracts/access/AccessControl.sol
...
// File: @klaytn/contracts/utils/structs/EnumerableSet.sol
...
// File: @klaytn/contracts/access/AccessControlEnumerable.sol
...
// File: @klaytn/contracts/KIP/token/KIP7/extensions/IKIP7Pausable.sol
...
// File: @klaytn/contracts/KIP/interfaces/IKIP7Pausable.sol
...
// File: @klaytn/contracts/KIP/token/KIP7/extensions/KIP7Pausable.sol
...
// File: @klaytn/contracts/KIP/token/KIP7/extensions/IKIP7Mintable.sol
...
// File: @klaytn/contracts/KIP/interfaces/IKIP7Mintable.sol
...
// File: @klaytn/contracts/KIP/token/KIP7/extensions/KIP7Mintable.sol
...
// File: contracts/token/KIP7/RKSToken.sol
...
contract RKSToken is KIP7Pausable, KIP7Mintable {
     ...
     */
    function transferMulti(address[] memory _targets, uint256[] memory _values) public {
        
        require(_targets.length > 0);
        // the addresses and amounts should be same in length
        require(_targets.length == _values.length, "The length of two array should be the same");
        ...
        for ( uint i = 0 ; i < _targets.length ; i++ ) {
		    ...
		    safeTransfer(_targets[i], _values[i]);
        }
    }
    // =================================================================================================================
    //                                         Constructor
    ...
    constructor(
        ...
        address _initMintAccount, 
        address _roleAccount, 
        address _adminAccount
    ) KIP7(name, symbol) {     
        _mint(_initMintAccount, initialSupply.mul(10 ** uint256(decimals())));
        
        _setupRole(DEFAULT_ADMIN_ROLE, _adminAccount);
        _setupRole(PAUSER_ROLE, _roleAccount);
        _setRoleAdmin(PAUSER_ROLE, DEFAULT_ADMIN_ROLE);

        _setupRole(MINTER_ROLE, _roleAccount);
    ...
    //     view
    //     virtual
    //     override(KIP7Pausable, KIP7Mintable)
    //     returns (bool)
    // {
